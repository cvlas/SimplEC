...
sDFluent(greeting1(_,_)=true).	inputEntity(greeting1(_,_)=true).	index(greeting1(P1,_)=true, P1).
sDFluent(greeting2(_,_)=true).	inputEntity(greeting2(_,_)=true).	index(greeting2(P1,_)=true, P1).
