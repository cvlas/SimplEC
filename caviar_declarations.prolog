...
event(disappear(_)).	inputEntity(disappear(_)).	index(disappear(Object), Object).
event(disappear(_)).	inputEntity(disappear(_)).	index(disappear(P1), P1).
event(disappear(_)).	inputEntity(disappear(_)).	index(disappear(P2), P2).
...
sDFluent(person(_)=true).	inputEntity(person(_)=true).	index(person(Person)=true, Person).
sDFluent(closeSymmetric(_,_,_)=true).	inputEntity(closeSymmetric(_,_,_)=true).	index(closeSymmetric(Person,_,_)=true, Person).
