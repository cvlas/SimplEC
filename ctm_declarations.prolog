...
sDFluent(internal_temperature(_,_)=very_cold).	inputEntity(internal_temperature(_,_)=very_cold).	index(internal_temperature(Id,_)=very_cold, Id).
sDFluent(internal_temperature(_,_)=very_warm).	inputEntity(internal_temperature(_,_)=very_warm).	index(internal_temperature(Id,_)=very_warm, Id).
sDFluent(noise_level(_,_)=high).	inputEntity(noise_level(_,_)=high).	index(noise_level(Id,_)=high, Id).
sDFluent(passenger_density(_,_)=high).	inputEntity(passenger_density(_,_)=high).	index(passenger_density(Id,_)=high, Id).
...
simpleFluent(internal_temperature(_,_)=Value).	outputEntity(internal_temperature(_,_)=Value).	index(internal_temperature(Id,_)=Value, Id).
...
simpleFluent(noise_level(_,_)=Value).	outputEntity(noise_level(_,_)=Value).	index(noise_level(Id,_)=Value, Id).
